...
import speech_recognition as sr #google speech-text
...
def math():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            def power():
                power = []
                for n, i in enumerate(optr): #enum
...
new_icon = new_icon.subsample(12, 12) # aspect ratio
